...
describe('Login Testing', () => { 
    ...
    test('halaman login sukses di tampilkan dengan memunculkan tulisan Sign In', () => { const textSignIn = screen.getByText("Sign In"); 
    expect(textSignIn).toBeInTheDocument(); 
}); 

test('melakukan input email pada formulir', () => { 
    userEvent.type(screen.getByTestId('input-email'), "agung@binarc.co.id"); expect(screen.getByTestId('input-email')).toHaveValue("agung@binarc.co.id"); }); 
