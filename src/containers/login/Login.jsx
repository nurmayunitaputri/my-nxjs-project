...
//     return ( 
//         <NoAuthProvider> 
//             <main className=" p-3 text-gray-700 h-screen max-w-md mx-auto flex flex-col spa ce-y-3 justify-center items-center"> 
...
//             </div> 
//             <form className="w-full border p-5 rounded-2xl" onSubmit={handleSubmit}> <Input 
//                 name="email" 
//                 label="Email" 
//                 type="text" 
    ...
    <main className="p-3 text-gray-700 h-screen max-w-md mx-auto flex flex-col space -y-3 justify-center items-center"> 
        <div className="w-full"> 
            ...
            <form className="w-full border p-5 rounded-2xl" onSubmit={handleSubmit}> <Input 
                ...
                <div className="text-xs text-red-500 pb-3">{getIn(errors, "email")}</div> 
                    ) 
                } 
                <Input
                    name="password" 
                    ...
                    { 
                        ...
                        <div className="text-xs text-red-500 pb-3">{getIn(errors, "password")} </div> 
                        ) 
                    } 
                    <Button type="submit" label={loading ? 'Please wait...' : 'Go to My Accoun t'} /> 
                </form> 
            </div> 
        </main> 
    </NoAuthProvider> 
