...
const Edit = () => { 
    ...
    const { upload: { post, loading }, makePost, makeLoading } = useUploadDispatcher(); 
        ...
        <MainLayout> 
            <form onSubmit={handleSubmit}> 
                <div className="h-60 bg-gray-100 "> 
                    <label htmlFor="files" className=" w-full h-full cursor-pointer flex justif y-center items-center "> 
                { 
                    preview ? ( 
            ...
            <div className="p-3"> 
                <Button type="submit" label={loading ? 'Please wait...' : 'Update post'} /> </div> 
            </form> 
        </MainLayout> 
    </AuthProvider> 
                ) 
